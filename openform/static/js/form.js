$(document).ready(function() {
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div><input type="text" placeholder="Instance Name" name="instance_name" /><input type="text" placeholder="Image ID" name="instance_image_id" /><input type="text" placeholder="Favlor ID" name="instance_flavor_id" /><input type="text" placeholder="Key pair name" name="instance_key_pair" /><input type="text" placeholder="Security groups" name="instance_security_groups" /><a href="#" class="remove_instance">X</a></div>');
        }
    });
